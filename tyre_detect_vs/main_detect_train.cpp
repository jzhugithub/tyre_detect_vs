...
//
//		//2.处理背景样本图片
//		for(int setIndex=0,num=IrobotTrainNo; setIndex<BackgroundSetNo && getline(BackgroundName,ImgName); setIndex++)  
//		{
...
//
//		//3.处理Hard背景样本图片
//		for(int setIndex=0,num=IrobotTrainNo+BackgroundTrainNo; setIndex<HardBackgroundSetNo && getline(HardBackgroundName,ImgName); setIndex++)  
//		{
